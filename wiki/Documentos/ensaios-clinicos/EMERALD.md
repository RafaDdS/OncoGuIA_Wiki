...
## Autores Principais:
Bidard FC, Kaklamani VG, Neven P, et al. (2022)
...
### Análise primária (2022)
- **SLP (população global):** redução de 30% no risco de progressão ou morte com elacestrano (HR 0,70; IC 95% 0,55–0,88; P = 0,002).
- **SLP (mutação ESR1 — 47,8% dos pacientes):** HR 0,55 (IC 95% 0,39–0,77; P = 0,0005).
- **Segurança:** eventos adversos grau 3/4 relacionados ao tratamento em 7,2% (elacestrano) versus 3,1% (SOC); descontinuações por EA relacionados em 3,4% versus 0,9%. Náusea de qualquer grau em 35,0% versus 18,8% (grau 3/4: 2,5% versus 0,9%).

## Impacto Clínico:
Primeiro SERD oral a demonstrar, em estudo de fase III, ganho significativo de SLP em relação à terapia endócrina padrão, tanto na população global quanto na com mutação de ESR1, constituindo nova opção de tratamento para pacientes com progressão após inibidores de CDK4/6.

## Referências

1. Bidard FC; Kaklamani VG; Neven P; et al. Elacestrant (oral selective estrogen receptor degrader) Versus Standard Endocrine Therapy for Estrogen Receptor-Positive, Human Epidermal Growth Factor Receptor 2-Negative Advanced Breast Cancer. J Clin Oncol. 2022;40(28):3246-56. DOI: [10.1200/JCO.22.00338](https://doi.org/10.1200/JCO.22.00338)
