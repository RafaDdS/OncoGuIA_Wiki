---
title: "TBCRC 048 (Olaparib Expanded)"
aliases:
  - "TBCRC 048"
  - "Olaparib Expanded"
...
## Autores Principais:
Tung NM, Robson ME, Ventz S, et al.

## Ano de Publicação:
2020

## Delineamento (Métodos):
Estudo de fase II, de braço único, iniciado por investigador, em dois estágios, que incluiu pacientes com [[Câncer de Mama (Visão Geral)|câncer de mama]] metastático com doença mensurável e mutações germinativas em genes de recombinação homóloga não-[[BRCA1 - BRCA2|BRCA1/2]] (coorte 1) ou mutações somáticas nesses genes ou em BRCA1/2 (coorte 2). Foram excluídos pacientes com uso prévio de inibidor de PARP, doença refratária a platina ou progressão em mais de dois esquemas de [[tratamento/quimioterapia/index|quimioterapia]] no cenário metastático. Todos receberam [[Olaparibe|olaparibe]] 300 mg VO duas vezes ao dia até progressão. Desfecho primário: taxa de resposta objetiva (TRO); desfechos secundários: taxa de benefício clínico e [[Sobrevida Livre de Progressão (SLP)|sobrevida livre de progressão (SLP)]].

## Objetivos:
Avaliar a resposta ao olaparibe em pacientes com câncer de mama metastático com mutações somáticas BRCA1/2 ou mutações germinativas/somáticas em genes de recombinação homóloga além de BRCA1/2.
