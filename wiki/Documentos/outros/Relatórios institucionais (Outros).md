---
title: "Relatórios institucionais (Outros)"
aliases:
...
Relatórios e dados institucionais/real-world:

## Controle do câncer de mama no Brasil – Dados e números: 2024 (INCA)

Publicação do **Instituto Nacional de Câncer (INCA)** que consolida dados epidemiológicos e indicadores do controle do [[Câncer de Mama (Visão Geral)|câncer de mama]] no Brasil, subsidiando o planejamento e a avaliação das ações de controle nos diferentes níveis do SUS.
...
1. INCA (Instituto Nacional de Câncer). Controle do câncer de mama no Brasil - Dados e números: 2024. Rio de Janeiro: INCA; 2024. (relatório institucional, sem DOI)