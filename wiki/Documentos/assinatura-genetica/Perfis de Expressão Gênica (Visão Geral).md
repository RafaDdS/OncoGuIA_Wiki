---
title: "Perfis de Expressão Gênica (Visão Geral)"
aliases:
...
Os perfis de expressão gênica (ou painéis genômicos) são testes laboratoriais avançados que analisam a biologia molecular do tumor. Em vez de observar apenas a anatomia ou o tamanho do câncer, esses testes medem a atividade (expressão do RNA) de grupos específicos de genes relacionados à proliferação celular, invasão e sinalização hormonal. O objetivo central é prever o comportamento do tumor e auxiliar o oncologista na decisão de prescrever ou omitir a [[tratamento/quimioterapia/index|quimioterapia]] adjuvante.

## Aplicações Clínicas e Tratamento

* **Indicação Principal:** São indicados quase exclusivamente para pacientes com [[Câncer de Mama (Visão Geral)|câncer de mama]] inicial com Receptor Hormonal positivo ([[Receptores Hormonais (RE-RP-RH)|RH]]+) e [[HER2|HER2 negativo]].
* **Limitações de Uso:** Estes testes não possuem valor preditivo ou prognóstico validado para pacientes com tumores HER2 positivo ou [[TNBC (Triplo-Negativo)|Triplo-Negativo]] (RH negativo), não devendo ser solicitados nesses cenários.
...
* **Contexto de Saúde Pública:** Apesar de seu alto valor na personalização do tratamento, o acesso a painéis genômicos no sistema público de saúde ainda é limitado devido aos custos. Na ausência dessas plataformas, a decisão pela quimioterapia deve continuar sendo guiada pelo uso rigoroso de variáveis clínico-patológicas e calculadoras de risco online (como o [[PREDICT]]).
