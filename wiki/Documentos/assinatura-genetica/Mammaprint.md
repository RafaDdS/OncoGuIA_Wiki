...
O Mammaprint é um ensaio genômico baseado em tecnologia de *microarray* que analisa a expressão de uma assinatura de 70 genes. Ao contrário do Oncotype que fornece uma pontuação contínua, o Mammaprint é categórico: ele classifica o tumor binariamente em "Baixo Risco Genômico" ou "[[Alto Risco Genômico]]".

## Aplicações Clínicas e Tratamento

* **População Alvo:** É frequentemente utilizado em pacientes com [[Câncer de Mama (Visão Geral)|câncer de mama]] [[Receptores Hormonais (RE-RP-RH)|RH]] positivo, [[HER2|HER2 negativo]], sem linfonodos comprometidos (N0) que, pelas características clínicas convencionais, teriam indicação de [[tratamento/quimioterapia/index|quimioterapia]] ([[Alto Risco Clínico|alto risco clínico]]).
...
* **Limitações:** Pacientes classificadas com baixo risco clínico (tumores pequenos, baixo grau) já possuem um prognóstico excelente e a literatura desaconselha a realização do teste, pois ele não alterará a conduta. Para pacientes com até 3 linfonodos acometidos, o teste pode ser feito, mas deve-se orientar que a quimioterapia ainda pode oferecer algum grau de proteção.

## Estudos-Chave

* **Estudo [[MINDACT]]:** Foi o pilar de validação do Mammaprint. Este ensaio prospectivo provou que pacientes com "Alto Risco Clínico" porém "Baixo Risco Genômico" podiam ser poupadas da quimioterapia sem comprometer significativamente a [[Sobrevida Global (SG)|sobrevida global]].
