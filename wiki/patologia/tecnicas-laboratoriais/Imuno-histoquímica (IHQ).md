...
A **imuno-histoquímica (IHQ)** é a técnica de detecção de antígenos celulares em cortes histológicos por meio de **anticorpos específicos** acoplados a sistemas de amplificação cromogênica ou fluorescente. No [[Câncer de Mama (Visão Geral)|câncer de mama]], é o método principal para classificação molecular substituta, determinação de [[biomarcadores/index|biomarcadores]] preditivos e orientação terapêutica.
...
- **E-caderina**: diferencia carcinoma ductal (positivo) de [[Carcinoma Lobular|carcinoma lobular]] (negativo por perda de expressão)
- **CK5 e CK14**: marcadores de células basais/mioepiteliais, úteis na caracterização de fenótipo basal-like (TNBC)
...
Variabilidade interlaboratorial e interobservador, especialmente para Ki67, justifica esforços de padronização (International Ki67 in Breast Cancer Working Group). A técnica detecta expressão proteica, não necessariamente atividade funcional ou alteração genética.
