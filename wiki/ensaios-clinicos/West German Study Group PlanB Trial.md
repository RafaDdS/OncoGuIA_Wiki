...
## Autores Principais:
Nitz U, Gluz O, Clemens M, Malter W, Reimer T, Nuding B, et al.

## Ano de Publicação:
2019

## Objetivos:
Avaliar se um regime de 6 ciclos de docetaxel/ciclofosfamida ([[TC (Docetaxel + Ciclofosfamida)|TC]]) é não-inferior a um regime de 4 ciclos de EC seguido de 4 ciclos de docetaxel em pacientes com [[Câncer de Mama (Visão Geral)|câncer de mama]] [[HER2|HER2-negativo]].
