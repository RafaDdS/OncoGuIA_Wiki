...
Páginas da categoria **Ensaios Clínicos**.

{{ gerar_lista_arquivos() }}


### Hierarquia dos Ensaios Clínicos (por Família/Cenário)

#### 1. TERAPIA ENDÓCRINA + INIBIDORES DE CDK4/6 (HR+)
- **Adjuvante (Alto Risco / Pós-Neoadjuvante)**
...
- **Metastático (1ª linha e combinações)**
  ...
  - `PALOMA-2` e `Paloma-3` (Palbociclib)
...
- **Neoadjuvante (Pré-operatório)**
  - `Letrozole Neoadjuvant Trial` (Letrozol)
  - `IMPACT` (Anastrozol, Tamoxifeno ou ambos)
  - `ACOSOG Z1031` (Letrozol, Anastrozol ou Exemestano)
  - `STAGE` (Anastrozol + Goserelin vs Tamoxifeno + Goserelin)
...
- **Adjuvante (Pós-cirúrgico)**
  ...
  - `PHARE` (6 meses vs 12 meses de Trastuzumabe)
  - `PERSEPHONE` (6 meses vs 12 meses de Trastuzumabe)
- **Neoadjuvante (Pré-operatório)**
  - `NOAH` (Trastuzumabe neoadjuvante)
...
- **Metastático (1ª linha e combos)**
  ...
  - `VELVET` (Pertuzumabe + Trastuzumabe + Vinorelbina)
  - `PERTAIN` (Trastuzumabe + AI ± Pertuzumabe)
  - `SYSUCC-002` (Trastuzumabe + Terapia Endócrina vs Trastuzumabe + Quimioterapia)
...
#### 5. PARP INIBIDORES E DEFICIÊNCIA DE RECOMBINAÇÃO (BRCA)
- `OlympiA` (Olaparib adjuvante para BRCA+)
- `OlympiAD` (Olaparib metastático para BRCA+)
- `EMBRACA` (Talazoparib metastático para BRCA+)
- `TBCRC 048` (Olaparib para mutações em genes de recombinação homóloga)
- `TNT` (Carboplatina vs Docetaxel em BRCA/TNBC)

#### 6. QUIMIOTERAPIA ADJUVANTE E NEODJUVANTE (GERAL)
- **Regimes Dose-densos**
  - `GIM4` (Dose-dense FEC vs EC-Docetaxel)
