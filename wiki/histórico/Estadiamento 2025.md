---
title: "Estadiamento e Diagnóstico – O que mudou de 2025 para 2026"
aliases:
  - "Histórico Estadiamento 2025"
category: "Histórico"
source_documents:
  - "SBOC - Estadiamento 2025"
tags:
  - "histórico"
  - "estadiamento"
  - "diagnóstico"
...
# Estadiamento e Diagnóstico – O que mudou de 2025 para 2026

Esta página descreve o panorama do [[estadiamento/index|estadiamento]] e [[diagnostico/index|diagnóstico]] do [[Câncer de Mama (Visão Geral)|câncer de mama]] de acordo com a diretriz [[Sociedade Brasileira de Oncologia Clínica (SBOC)|SBOC]] de **2025** e lista as principais mudanças incorporadas em **2026**. Para a conduta atual, consulte SBOC - Estadiamento (2026).
...
- **2025**: "não se observa redução na mortalidade, mas sim tendência de aumento".
- **2026**: Esclarecimento: **cobertura da mamografia é de apenas 30%** (muito abaixo dos 70% da OMS), e a mortalidade bruta tem tendência de alta. Isso contextualiza a dificuldade de implementação do rastreamento no SUS.
...
- A recomendação formal do ultrassom de mamas/axilas com NE ALTO padroniza a avaliação locorregional, reduzindo variações.
- A não indicação de PD-L1 na doença inicial evita exames desnecessários e custos.
- A avaliação de TILs pode ajudar no prognóstico e na decisão de neoadjuvância em TNBC/HER2+.
- O monitoramento de intervalos assistenciais visa reduzir atrasos, especialmente no SUS, onde o diagnóstico tardio é um problema crítico.
- A consolidação dos [[cuidados-adicionais/index|cuidados adicionais]] facilita a consulta e a implementação de práticas multidisciplinares.
