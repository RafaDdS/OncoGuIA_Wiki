...
* **Avaliação Conjunta:** Devido à variabilidade e à possibilidade de falsos positivos ou negativos, os resultados dos marcadores tumorais não devem ser interpretados isoladamente. Eles devem sempre ser correlacionados com o histórico da paciente, o exame físico e os exames de imagem.

---

## Abordagem Clínica e Monitoramento

Ao contrário de biomarcadores moleculares que definem tratamentos específicos, o CEA e o CA 15-3 são ferramentas de acompanhamento.

### Cenários Iniciais (Estadiamento e Doença Localizada)

Nas fases iniciais do câncer de mama, a solicitação rotineira desses marcadores não é recomendada pelas principais diretrizes clínicas para o estadiamento inicial ou para o seguimento (follow-up) de pacientes após o tratamento com intenção curativa. Nesses contextos, os marcadores apresentam baixa sensibilidade para detectar recidivas precoces de forma confiável, não impactando a sobrevida global.
