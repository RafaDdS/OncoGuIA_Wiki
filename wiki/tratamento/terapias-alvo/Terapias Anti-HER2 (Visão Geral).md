---
title: "Terapias Anti-HER2 (Visão Geral)"
aliases:
  - "Trastuzumabe / Pertuzumabe / T-DM1"
...
Os anticorpos monoclonais [[Trastuzumabe|trastuzumabe]] e [[Pertuzumabe|pertuzumabe]] ligam-se a domínios extracelulares distintos do HER2 (subdomínio IV e II, respectivamente), inibindo a dimerização e a sinalização downstream (PI3K/AKT e MAPK), além de induzir citotoxicidade celular dependente de anticorpo (ADCC). Os ADCs ([[T-DM1 (Trastuzumabe Emtansina)|T-DM1]], [[T-DXd (Trastuzumabe Deruxtecana)|T-DXd]]) combinam trastuzumabe com um payload citotóxico (emtansina ou deruxtecana), liberado intracelularmente após internalização. Os TKIs ([[Neratinibe|neratinibe]], tucatinibe) inibem a atividade tirosina quinase intracelular do HER2.
