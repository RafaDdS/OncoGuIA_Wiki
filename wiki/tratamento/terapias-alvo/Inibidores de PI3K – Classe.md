---
title: "Inibidores de PI3K – Classe"
aliases:
  - "Inibidores de PI3K"
...
| Estudo | Cenário | Comparação | PFS | Taxa de resposta |
|--------|---------|------------|-----|-----------------|
...
A via PI3K/AKT/mTOR é um dos principais eixos de sinalização downstream do receptor de estrogênio e de receptores de fatores de crescimento. Mutações ativadoras em PIK3CA (exon 9 e exon 20) mantêm a sinalização proliferativa mesmo na presença de bloqueio estrogênico. Os inibidores de PI3Kα (alpelisibe, inavolisibe) ligam-se seletivamente à subunidade p110α mutada, restaurando a sensibilidade à [[tratamento/terapia-endocrina/index|terapia endócrina]].
...
Ambos exigem monitoramento rigoroso de glicemia de jejum e hemoglobina glicada (HbA1c) no início e a cada ciclo, além de avaliação de rash cutâneo e função hepática. A hiperglicemia induzida pelo inibidor de PI3K é dependente de dose e reversível com pausa e ajuste, sendo o gatilho para interrupção glicemia de jejum > 500 mg/dL ou HbA1c > 10%.
